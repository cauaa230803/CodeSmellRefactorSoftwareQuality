...
public class StudyTaskManager {
    ...
    public void setUpWeek(WeekSetup weekSetup){
        ...
        this.weekResponsibilities.addAll(Arrays.asList(weekSetup.planName(), weekSetup.objectiveTitle(), weekSetup.objectiveDescription(), weekSetup.materialTopic(), weekSetup.materialFormat(), weekSetup.goal(), weekSetup.reminderTitle(), weekSetup.reminderDescription(), weekSetup.mainTaskTitle(), weekSetup.mainHabit(), weekSetup.mainCardStudy()));
    }

    public void handleSetUpWeek(List<String> stringProperties){
        setUpWeek(
                new WeekSetup(stringProperties.get(0), stringProperties.get(1), stringProperties.get(2), stringProperties.get(3), stringProperties.get(4), stringProperties.get(5), stringProperties.get(6), stringProperties.get(7), stringProperties.get(8), stringProperties.get(9), stringProperties.get(10)));
    }
